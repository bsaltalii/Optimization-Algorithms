...
public class Task7_GWO {
    ...
    public static void main(String[] args) {
        ...
        for (int t = 0; t < max_iter; t++) {
            ...
            for (int i = 0; i < n_agents; i++) {
                double fitness = schwefel(positions[i]);
            ...
            for (int i = 0; i < n_agents; i++) {
                for (int j = 0; j < dim; j++) {
                    ...
                    else if (positions[i][j] < lowerBound)
    ...
    static void initializeAgents() {
        for (int i = 0; i < n_agents; i++) {
            for (int j = 0; j < dim; j++) {
                positions[i][j] = lowerBound + (upperBound - lowerBound) * rand.nextDouble();
            }
        }
    }
